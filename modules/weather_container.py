...
class WeatherContainer(widgets.QFrame):
    ...
    # def creating_weather_container(self)  :
        ...
        self.SCROLL_LEFT_BUTTON.setStyleSheet("background-color: transparent; border-radius: 0px; color: white;")
        ...
        self.SCROLL_RIGHT_BUTTON.setStyleSheet("background-color: transparent; border-radius: 0px; color: white;")
